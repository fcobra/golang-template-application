		...
		case '/': // Prefix: "/api/v1/"
			...
			case 'd': // Prefix: "data"
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "POST":
						s.handlePostDataRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, "POST")
					}
		...
		case '/': // Prefix: "/api/v1/"
				...
				case 'm': // Prefix: "me"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.summary = "Get current user info"
							r.operationID = "getMe"
							r.operationGroup = ""
			...
			case 'c': // Prefix: "catalog"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Get catalog items"
						r.operationID = "getCatalog"
						r.operationGroup = ""
						r.pathPattern = "/api/v1/catalog"
						r.args = args
						r.count = 0
						return r, true
					default:
			...
			case 'd': // Prefix: "data"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "POST":
						r.name = PostDataOperation
						r.summary = "Post some data"
						r.operationID = "postData"
						r.operationGroup = ""
						r.pathPattern = "/api/v1/data"
						r.args = args
						r.count = 0
						return r, true
					default:
